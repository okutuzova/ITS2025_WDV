...
<div style="margin-top: 40px;">
        <a href="{{ route('quiz') }}" style="padding: 10px 20px; background-color: #3490dc; color: white; text-decoration: none; border-radius: 5px;">Start Country Quiz</a>
        <a href="{{ route('flags_quiz') }}" style="padding: 10px 20px; background-color:rgb(238, 140, 11); color: white; text-decoration: none; border-radius: 5px; margin-left: 20px;">Start Flag Quiz</a>
